 ...
 */
final class Version20230303110357 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE realization_step (id INT AUTO_INCREMENT NOT NULL, recipe_id INT DEFAULT NULL, INDEX IDX_22591A4859D8A214 (recipe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE realization_step ADD CONSTRAINT FK_22591A4859D8A214 FOREIGN KEY (recipe_id) REFERENCES recipe (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE realization_step DROP FOREIGN KEY FK_22591A4859D8A214');
        $this->addSql('ALTER TABLE recipe_ingredient DROP FOREIGN KEY FK_22D1FE1359D8A214');
        $this->addSql('ALTER TABLE recipe_ingredient DROP FOREIGN KEY FK_22D1FE13933FE08C');
        $this->addSql('DROP TABLE ingredient');
        $this->addSql('DROP TABLE realization_step');
